            ...
            <div className="storeNav">
                <div className="navContent">
                    ...
                    <div className="storeLinks">
                        ...
                        <span className={(filter=="shirt")?"active-tab":""}
                        onClick={()=>changeUrl('shirt')}>Shirt</span>
                        <span className={(filter=="hat")?"active-tab":""}
                        onClick={()=>changeUrl('hat')}>Hat</span>
                    </div>
                    ...
                    <Dropdown.Menu>
                        ...
                        <Dropdown.Item href="#" onClick={()=>filterDataList('shirt')}>Shirt</Dropdown.Item>
                        <Dropdown.Item href="#" onClick={()=>filterDataList('hat')}>Hat</Dropdown.Item>
                    </Dropdown.Menu>
                    </Dropdown>
                </div>
            </div>
